  ...
  return (
    <section className={styles.section}>
        ...
        <div className={styles.content}>
            ...
            <p>In our inviting and dynamic setting at Liberty Learning Academy, children engage in exploration, play, and learning in unison. Our priority is ensuring they experience joy, security, and affection as they embark on daily discoveries. <br /><br />
